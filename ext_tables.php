...
$tempColumns = array(
	'tx_adgooglemapspluginfeuser_feusers' => array(
		...
		'displayCond' => 'FIELD:coordinates_provider:=:Tx_AdGoogleMapsPluginFeuser_MapManager_CoordinatesProvider_FrontendUsers',
		'config' => array(
			'type' => 'select',
			'size' => '5',
			'autoSizeMax' => 15,
	...
	'tx_adgooglemapspluginfeuser_fegroups' => array(
		...
		'exclude' => true,
		'l10n_mode' => $excludeProperties,
		'displayCond' => 'FIELD:coordinates_provider:=:Tx_AdGoogleMapsPluginFeuser_MapManager_CoordinatesProvider_FrontendUserGroups',
		'config' => array(
			'type' => 'select',
			'size' => '5',
			'autoSizeMax' => 15,
